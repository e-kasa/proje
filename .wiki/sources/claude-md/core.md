---
title: CLAUDE.md — core
type: source
source: core/CLAUDE.md
ingested: 2026-04-25
...
Genel kurallar: kök `CLAUDE.md`. Multi-tenant: `.wiki/concepts/multi-tenant-routing.md`. JWT modelleri: `.wiki/concepts/jwt-payload.md`.
...
Yeni `/api/**` public endpoint eklerken **4 yer senkron**: `.wiki/concepts/url-routing.md`.
...
Modüllerde proje exception'larını kullan (`NotFoundException`, `BusinessException` vb.) — `.wiki/concepts/api-response.md`.
