---
title: CLAUDE.md — project_pos (Flutter)
type: source
source: project_pos/CLAUDE.md
ingested: 2026-04-25
...
URL kuralı: `.wiki/concepts/url-routing.md`. API zarfı: `.wiki/concepts/api-response.md`.  
JWT parse: `.wiki/concepts/jwt-payload.md`. Sektör: `.wiki/concepts/sector-strings.md`.  
Yeni feature: `.wiki/syntheses/runbook-new-feature-flutter.md`.
...
Detaylı şablon: `.wiki/syntheses/runbook-new-feature-flutter.md`.
...
JWT parse detayı: `.wiki/concepts/jwt-payload.md`.
...
Detay: `.wiki/decisions/2026-04-13-location-id-unification.md`.
