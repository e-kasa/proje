...
└─ Product (her yeni satır için 1)
   ...
   └─ ProductVariant (footwear: N · diğer: 1)
       ...
       │
       ├─ OemNumber (TÜM variantlara × tüm OEM'ler)  ← 2026-04-21: variant[0] yerine tümüne bindirilir
...
| `newProducts[].oemNumbers[]` | `OemNumber` (TÜM variantlara) | 2026-04-21 düzeltildi |
| `newProducts[].crossReferences[]` | `CrossReference` (TÜM variantlara) | 2026-04-21 düzeltildi |
...
## 8. Kritik Düzeltmeler (2026-04-21)
