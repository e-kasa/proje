...
public class CategoryControllerImpl implements CategoryController {
    ...
    public ResponseEntity<ApiResponse<DtoCategory>> createCategory(@RequestBody DtoCategoryUI dtoCategoryUI) {
        try {
            ...
            log.error("Kategori oluşturma hatası: {}", e.getMessage(), e);
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Kategori oluşturulurken hata oluştu: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<DtoCategory>> updateCategory(
        ...
        try {
            ...
            log.error("Kategori güncelleme hatası: {}", e.getMessage(), e);
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Kategori güncellenirken hata oluştu: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deleteCategory(@PathVariable String id) {
        try {
            ...
            log.error("Kategori silme hatası: {}", e.getMessage(), e);
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Kategori silinirken hata oluştu: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<DtoCategory>> getCategoryById(@PathVariable String id) {
        try {
            ...
            log.error("Kategori getirme hatası: {}", e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(ApiResponse.error("Kategori bulunamadı: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<List<DtoCategory>>> getAllCategories() {
        try {
            ...
            log.error("Kategoriler listeleme hatası: {}", e.getMessage(), e);
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Kategoriler listelenirken hata oluştu: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<List<DtoCategory>>> getRootCategories() {
        try {
            ...
            log.error("Ana kategoriler listeleme hatası: {}", e.getMessage(), e);
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Ana kategoriler listelenirken hata oluştu: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<List<DtoCategory>>> getChildCategories(@PathVariable String parentId) {
        try {
            ...
            log.error("Alt kategoriler listeleme hatası: {}", e.getMessage(), e);
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Alt kategoriler listelenirken hata oluştu: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<List<DtoCategory>>> getCategoryTree() {
        try {
            ...
            log.error("Kategori ağacı listeleme hatası: {}", e.getMessage(), e);
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Kategori ağacı listelenirken hata oluştu: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<String>> getCategoryPath(@PathVariable String categoryId) {
        try {
            ...
            log.error("Kategori yolu getirme hatası: {}", e.getMessage(), e);
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Kategori yolu getirilirken hata oluştu: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<String>> generateSlug(@RequestParam String name) {
        try {
            ...
            log.error("Slug oluşturma hatası: {}", e.getMessage(), e);
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Slug oluşturulurken hata oluştu: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Void>> updateSortOrder(
        ...
        try {
            ...
            log.error("Sıralama güncelleme hatası: {}", e.getMessage(), e);
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Sıralama güncellenirken hata oluştu: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<DtoCategory>> getCategoryWithRelations(
        ...
        try {
            ...
            log.error("Kategori ilişkileriyle getirme hatası: {}", e.getMessage(), e);
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Kategori getirilirken hata oluştu: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<List<DtoCategory>>> getCategoryTreeWithRelations() {
        try {
            ...
            log.error("Kategori ağacı ilişkilerle listeleme hatası: {}", e.getMessage(), e);
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Kategori ağacı listelenirken hata oluştu: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<CategoryVariant>> addVariantToCategory(String categoryId,
        ...
        try {
           ...
           return ResponseEntity.ok(ApiResponse.success("Kategori alt kategorileriyle başarıyla getirildi", categoryVariant));
              ...
              log.error("Kategoriye varyanat ekleme hatası: {}", e.getMessage(), e);
            return ResponseEntity.badRequest()
                    .body(ApiResponse.error("Kategoriye varyanat ekleme hatası: " + e.getMessage()));
        }
    }
