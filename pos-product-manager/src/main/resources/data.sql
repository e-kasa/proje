...
VALUES
    ...
    ('cce-0001-0000-0000-0000-000000000001','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'cat-elb1-0000-0000-0000-000000000001',true,6),
    ('cce-0001-0000-0000-0000-000000000002','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'cat-elb2-0000-0000-0000-000000000001',true,7),
    ('cce-0001-0000-0000-0000-000000000003','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'cat-elb2-0000-0000-0000-000000000002',true,8),
    ('cce-0001-0000-0000-0000-000000000004','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'cat-elb2-0000-0000-0000-000000000003',true,9),
    ('cce-0001-0000-0000-0000-000000000005','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'cat-elb2-0000-0000-0000-000000000004',true,10)
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    ('brd-0001-0000-0000-0000-000000000005','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'LC Waikiki','LCW','Türk giyim markası',true),
    ('brd-0001-0000-0000-0000-000000000006','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'Mavi','MAVI','Türk denim markası',true),
    ('brd-0001-0000-0000-0000-000000000007','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'Koton','KOTON','Türk giyim markası',true)
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    ('sup-0001-0000-0000-0000-000000000002','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
...
VALUES
    ...
    ('sac-0001-0000-0000-0000-000000000002','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
...
VALUES
    ...
    ('cus-0001-0000-0000-0000-000000000002','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Bireysel Musteri','0533 444 55 66','musteri@email.com','Istanbul',
     'Perakende','INDIVIDUAL',NULL,NULL,5000.00,0,'NORMAL',true,false)
ON CONFLICT (id) DO NOTHING;
...
(id, create_user, company_code, create_time, last_modified_time,
 name, sku, slug, category_id, brand, unit, description, is_deleted, status)
VALUES
    ('prd-elb1-0000-0000-0000-000000000001','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
    ...
    ('prd-elb1-0000-0000-0000-000000000002','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
    ...
    ('prd-elb1-0000-0000-0000-000000000003','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
    ...
    ('prd-elb1-0000-0000-0000-000000000004','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Kapusonlu Sweatshirt','SWT-KAP-001','sweatshirt',
     'cat-elb2-0000-0000-0000-000000000001','LC Waikiki','ADET',
     'Unisex kapusonlu sweatshirt 3 iplik',false,'ACTIVE'),

    ('prd-elb1-0000-0000-0000-000000000005','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
...
VALUES
    -- T-Shirt: S / M / L
    ('var-elb1-0000-0000-0000-000000000001','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'TSH-S','tshirt-s','T-Shirt S','prd-elb1-0000-0000-0000-000000000001',false,10,'F-01',0.00),
    ('var-elb1-0000-0000-0000-000000000002','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'TSH-M','tshirt-m','T-Shirt M','prd-elb1-0000-0000-0000-000000000001',false,10,'F-02',0.00),
    ('var-elb1-0000-0000-0000-000000000003','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'TSH-L','tshirt-l','T-Shirt L','prd-elb1-0000-0000-0000-000000000001',false,10,'F-03',0.00),

    -- Slim Fit Jean: 30 / 32 / 34
    ('var-elb1-0000-0000-0000-000000000004','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'JEN-30','jean-30','Slim Fit Jean 30','prd-elb1-0000-0000-0000-000000000002',false,5,'G-01',0.00),
    ('var-elb1-0000-0000-0000-000000000005','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'JEN-32','jean-32','Slim Fit Jean 32','prd-elb1-0000-0000-0000-000000000002',false,5,'G-02',0.00),
    ('var-elb1-0000-0000-0000-000000000006','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'JEN-34','jean-34','Slim Fit Jean 34','prd-elb1-0000-0000-0000-000000000002',false,5,'G-03',0.00),

    -- Midi Elbise: S / M / L
    ('var-elb1-0000-0000-0000-000000000007','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'ELB-S','elbise-s','Midi Elbise S','prd-elb1-0000-0000-0000-000000000003',false,8,'H-01',0.00),
    ('var-elb1-0000-0000-0000-000000000008','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'ELB-M','elbise-m','Midi Elbise M','prd-elb1-0000-0000-0000-000000000003',false,8,'H-02',0.00),
    ('var-elb1-0000-0000-0000-000000000009','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'ELB-L','elbise-l','Midi Elbise L','prd-elb1-0000-0000-0000-000000000003',false,8,'H-03',0.00),

    -- Sweatshirt: S / M / L
    ('var-elb1-0000-0000-0000-000000000010','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'SWT-S','sweatshirt-s','Sweatshirt S','prd-elb1-0000-0000-0000-000000000004',false,10,'I-01',0.00),
    ('var-elb1-0000-0000-0000-000000000011','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'SWT-M','sweatshirt-m','Sweatshirt M','prd-elb1-0000-0000-0000-000000000004',false,10,'I-02',0.00),
    ('var-elb1-0000-0000-0000-000000000012','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'SWT-L','sweatshirt-l','Sweatshirt L','prd-elb1-0000-0000-0000-000000000004',false,10,'I-03',0.00),

    -- Kis Montu: S / M / L
    ('var-elb1-0000-0000-0000-000000000013','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'MNT-S','mont-s','Kis Montu S','prd-elb1-0000-0000-0000-000000000005',false,5,'J-01',0.00),
    ('var-elb1-0000-0000-0000-000000000014','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'MNT-M','mont-m','Kis Montu M','prd-elb1-0000-0000-0000-000000000005',false,5,'J-02',0.00),
    ('var-elb1-0000-0000-0000-000000000015','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
...
VALUES
    ...
    -- Elbise
    ('brc-elb1-0000-0000-0000-000000000001','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000001','8692000000001','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000002','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000002','8692000000002','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000003','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000003','8692000000003','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000004','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000004','8692000000004','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000005','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000005','8692000000005','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000006','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000006','8692000000006','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000007','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000007','8692000000007','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000008','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000008','8692000000008','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000009','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000009','8692000000009','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000010','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000010','8692000000010','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000011','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000011','8692000000011','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000012','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000012','8692000000012','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000013','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000013','8692000000013','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000014','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000014','8692000000014','EAN13',true,true,0),
    ('brc-elb1-0000-0000-0000-000000000015','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000015','8692000000015','EAN13',true,true,0)
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    -- Elbise fiyatlari
    ('vpr-elb1-0000-0000-0000-000000000001','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000001', 80.00,149.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000002','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000002', 80.00,149.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000003','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000003', 80.00,149.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000004','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000004',350.00,649.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000005','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000005',350.00,649.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000006','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000006',350.00,649.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000007','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000007',220.00,399.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000008','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000008',220.00,399.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000009','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000009',220.00,399.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000010','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000010',160.00,299.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000011','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000011',160.00,299.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000012','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000012',160.00,299.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000013','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000013',550.00,999.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000014','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000014',550.00,999.00,'TRY',8.00,0.00,false,0.00,false),
    ('vpr-elb1-0000-0000-0000-000000000015','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000015',550.00,999.00,'TRY',8.00,0.00,false,0.00,false)
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    -- Elbise
    ('stm-elb1-0000-0000-0000-000000000001','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000001','STORE-01','WH-01','PURCHASE_IN',50),
    ('stm-elb1-0000-0000-0000-000000000002','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000002','STORE-01','WH-01','PURCHASE_IN',60),
    ('stm-elb1-0000-0000-0000-000000000003','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000003','STORE-01','WH-01','PURCHASE_IN',45),
    ('stm-elb1-0000-0000-0000-000000000004','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000004','STORE-01','WH-01','PURCHASE_IN',20),
    ('stm-elb1-0000-0000-0000-000000000005','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000005','STORE-01','WH-01','PURCHASE_IN',25),
    ('stm-elb1-0000-0000-0000-000000000006','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000006','STORE-01','WH-01','PURCHASE_IN',18),
    ('stm-elb1-0000-0000-0000-000000000007','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000007','STORE-01','WH-01','PURCHASE_IN',30),
    ('stm-elb1-0000-0000-0000-000000000008','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000008','STORE-01','WH-01','PURCHASE_IN',35),
    ('stm-elb1-0000-0000-0000-000000000009','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000009','STORE-01','WH-01','PURCHASE_IN',28),
    ('stm-elb1-0000-0000-0000-000000000010','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000010','STORE-01','WH-01','PURCHASE_IN',40),
    ('stm-elb1-0000-0000-0000-000000000011','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000011','STORE-01','WH-01','PURCHASE_IN',50),
    ('stm-elb1-0000-0000-0000-000000000012','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000012','STORE-01','WH-01','PURCHASE_IN',42),
    ('stm-elb1-0000-0000-0000-000000000013','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000013','STORE-01','WH-01','PURCHASE_IN',15),
    ('stm-elb1-0000-0000-0000-000000000014','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000014','STORE-01','WH-01','PURCHASE_IN',18),
    ('stm-elb1-0000-0000-0000-000000000015','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'var-elb1-0000-0000-0000-000000000015','STORE-01','WH-01','PURCHASE_IN',12)
ON CONFLICT (id) DO NOTHING;
...
-- admin → admin123 | kasiyer → kasiyer123
