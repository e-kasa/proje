...
(id, create_user, company_code, create_time, last_modified_time, name, code, description, is_active)
VALUES
    ('brd-00001-0000-0000-0000-000000000011','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'Xiaomi','XIAOMI','Akıllı telefon ve tablet',true),
    ('brd-00001-0000-0000-0000-000000000012','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'Lenovo','LENOVO','Bilgisayar ve laptop',true),
    ('brd-00001-0000-0000-0000-000000000013','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'HP','HP','Yazıcı ve bilgisayar',true),
    ('brd-00001-0000-0000-0000-000000000014','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'Faber-Castell','FABERCASTELL','Kırtasiye ve sanat malzemeleri',true),
    ('brd-00001-0000-0000-0000-000000000015','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'Levi''s','LEVIS','Denim ve moda giyim',true),
    ('brd-00001-0000-0000-0000-000000000016','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'Koton','KOTON','Moda ve giyim',true),
    ('brd-00001-0000-0000-0000-000000000017','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'Chicco','CHICCO','Bebek giyim ve ürünleri',true),
    ('brd-00001-0000-0000-0000-000000000018','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'3M','3M','Ofis ve endüstriyel ürünler',true)
ON CONFLICT (id) DO NOTHING;

-- ============================================================
-- 16. YENİ ÜRÜNLER — Elektronik / Giyim / Ayakkabı / Kırtasiye
-- ============================================================
...
VALUES
    -- ── ELEKTRONİK ─────────────────────────────────────────
    ('prd-00001-0000-0000-0000-000000000013','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Apple iPhone 15','PRD-IPHONE-15','apple-iphone-15',
     'cat-0003-0000-0000-0000-000000000001','Apple','ADET',
     'Apple iPhone 15 6.1 inc Dynamic Island A16 cip',false,'ACTIVE'),

    ('prd-00001-0000-0000-0000-000000000014','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Samsung Galaxy Tab S9','PRD-SAM-TABS9','samsung-galaxy-tab-s9',
     'cat-0003-0000-0000-0000-000000000002','Samsung','ADET',
     'Samsung Galaxy Tab S9 11 inc Dynamic AMOLED 2X',false,'ACTIVE'),

    ('prd-00001-0000-0000-0000-000000000015','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Lenovo ThinkPad L14 Gen 4','PRD-LENOVO-L14G4','lenovo-thinkpad-l14-gen4',
     'cat-0003-0000-0000-0000-000000000003','Lenovo','ADET',
     'Lenovo ThinkPad L14 Gen 4 14 inc is laptopu',false,'ACTIVE'),

    ('prd-00001-0000-0000-0000-000000000016','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Samsung 55" QLED 4K Smart TV','PRD-SAM-TV55Q','samsung-55-qled-4k-tv',
     'cat-0003-0000-0000-0000-000000000005','Samsung','ADET',
     'Samsung 55 inc QLED 4K UHD Smart TV Tizen OS',false,'ACTIVE'),

    ('prd-00001-0000-0000-0000-000000000017','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'LG 27" QHD IPS Monitör','PRD-LG-27QP','lg-27-qhd-ips-monitor',
     'cat-0003-0000-0000-0000-000000000006','LG','ADET',
     'LG 27QP500 27 inc QHD IPS 75Hz gaming monitor',false,'ACTIVE'),

    ('prd-00001-0000-0000-0000-000000000018','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Xiaomi Redmi Note 13 Pro','PRD-REDMI-N13P','xiaomi-redmi-note-13-pro',
     'cat-0003-0000-0000-0000-000000000001','Xiaomi','ADET',
     'Xiaomi Redmi Note 13 Pro 6.67 inc AMOLED 200MP kamera',false,'ACTIVE'),

    ('prd-00001-0000-0000-0000-000000000019','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Xiaomi Pad 6','PRD-XIAOMI-PAD6','xiaomi-pad-6',
     'cat-0003-0000-0000-0000-000000000002','Xiaomi','ADET',
     'Xiaomi Pad 6 11 inc 2.8K 144Hz Snapdragon 870',false,'ACTIVE'),

    ('prd-00001-0000-0000-0000-000000000020','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'HP Deskjet Plus 4120 Yazıcı','PRD-HP-DJ4120','hp-deskjet-plus-4120',
     'cat-0002-0000-0000-0000-000000000004','HP','ADET',
     'HP Deskjet Plus 4120 All-in-One WiFi renkli yazici',false,'ACTIVE'),

    -- ── GİYİM — ERKEK ──────────────────────────────────────
    ('prd-00001-0000-0000-0000-000000000021','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Adidas Trefoil Erkek T-Shirt','PRD-ADIDAS-TREFOIL','adidas-trefoil-erkek-tshirt',
     'cat-0003-0000-0000-0000-000000000007','Adidas','ADET',
     'Adidas Originals Trefoil logolu %100 pamuk erkek tisort',false,'ACTIVE'),

    ('prd-00001-0000-0000-0000-000000000022','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Levi''s 501 Original Fit Kot Pantolon','PRD-LEVIS-501','levis-501-original-kot',
     'cat-0003-0000-0000-0000-000000000008','Levi''s','ADET',
     'Levi''s 501 Original Fit erkek duz kesim kot pantolon',false,'ACTIVE'),

    -- ── GİYİM — KADIN ──────────────────────────────────────
    ('prd-00001-0000-0000-0000-000000000023','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Yazlık Midi Elbise','PRD-MIDI-ELBISE','yazlik-midi-elbise',
     'cat-0003-0000-0000-0000-000000000009','LC Waikiki','ADET',
     'Kadin vizkon yasli midi boy yazlik elbise',false,'ACTIVE'),

    ('prd-00001-0000-0000-0000-000000000024','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Keten Uzun Bluz','PRD-KETEN-BLUZ','kadin-keten-uzun-bluz',
     'cat-0003-0000-0000-0000-000000000010','Koton','ADET',
     'Kadin %100 keten dokuma dugmeli uzun bluz',false,'ACTIVE'),

    -- ── GİYİM — ÇOCUK / BEBEK ──────────────────────────────
    ('prd-00001-0000-0000-0000-000000000025','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Bebek 5''li Zibin Seti','PRD-BEBEK-ZIBIN','bebek-5li-zibin-seti',
     'cat-0003-0000-0000-0000-000000000011','Chicco','SET',
     'Chicco 5 parcali bebek zibin seti %100 organik pamuk',false,'ACTIVE'),

    ('prd-00001-0000-0000-0000-000000000026','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Çocuk Kapüşonlu Sweatshirt','PRD-COCUK-SWEAT','cocuk-kapuslu-sweatshirt',
     'cat-0003-0000-0000-0000-000000000012','Nike','ADET',
     'Nike Sportswear Club Fleece cocuk kapuslu sweatshirt',false,'ACTIVE'),

    -- ── AYAKKABI ────────────────────────────────────────────
    ('prd-00001-0000-0000-0000-000000000027','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Nike Air Max 270 Spor Ayakkabı','PRD-NIKE-AM270','nike-air-max-270-erkek',
     'cat-0003-0000-0000-0000-000000000013','Nike','ÇİFT',
     'Nike Air Max 270 erkek gunluk spor ayakkabi',false,'ACTIVE'),

    ('prd-00001-0000-0000-0000-000000000028','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Deri Oxford Klasik Ayakkabı','PRD-OXFORD-DERI','deri-oxford-klasik-ayakkabi',
     'cat-0003-0000-0000-0000-000000000014','Mavi','ÇİFT',
     'Erkek hakiki deri bagcikli oxford klasik ayakkabi',false,'ACTIVE'),

    -- ── KIRTASİYE ───────────────────────────────────────────
    ('prd-00001-0000-0000-0000-000000000029','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'Faber-Castell Polychromos Kalem Seti','PRD-FC-POLY','faber-castell-polychromos-set',
     'cat-0001-0000-0000-0000-000000000005','Faber-Castell','SET',
     'Faber-Castell Polychromos profesyonel kuru boya kalemi seti',false,'ACTIVE'),

    ('prd-00001-0000-0000-0000-000000000030','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     '3M Post-it Yapışkan Not Kağıdı','PRD-POSTIT-SET','3m-postit-yapiskannot',
     'cat-0001-0000-0000-0000-000000000005','3M','PAKET',
     '3M Post-it orijinal yapiskannot kagidi seti',false,'ACTIVE')
ON CONFLICT (id) DO NOTHING;

-- ── 16b. PRODUCT_VARIANTS ────────────────────────────────────
INSERT INTO product_variants
(id, create_user, company_code, create_time, last_modified_time,
 sku, slug, name, additional_price, attributes, product_id, is_deleted)
VALUES
    -- iPhone 15 (prd-013)
    ('pvr-00001-0000-0000-0000-000000000025','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'IPHONE15-BLK-128','iphone15-siyah-128','iPhone 15 Siyah 128GB',
     0.00,'{"color":"Siyah","storage":"128 GB"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000013',false),
    ('pvr-00001-0000-0000-0000-000000000026','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'IPHONE15-WHT-128','iphone15-beyaz-128','iPhone 15 Beyaz 128GB',
     0.00,'{"color":"Beyaz","storage":"128 GB"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000013',false),
    ('pvr-00001-0000-0000-0000-000000000027','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'IPHONE15-BLK-256','iphone15-siyah-256','iPhone 15 Siyah 256GB',
     3000.00,'{"color":"Siyah","storage":"256 GB"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000013',false),
    ('pvr-00001-0000-0000-0000-000000000028','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'IPHONE15-PNK-256','iphone15-pembe-256','iPhone 15 Pembe 256GB',
     3000.00,'{"color":"Pembe","storage":"256 GB"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000013',false),

    -- Samsung Galaxy Tab S9 (prd-014)
    ('pvr-00001-0000-0000-0000-000000000029','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'TABS9-GCY-128','tab-s9-gece-128','Samsung Galaxy Tab S9 Gece Yarisi 128GB',
     0.00,'{"color":"Gece Yarisi","storage":"128 GB"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000014',false),
    ('pvr-00001-0000-0000-0000-000000000030','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'TABS9-KRM-256','tab-s9-krem-256','Samsung Galaxy Tab S9 Krem 256GB',
     5000.00,'{"color":"Krem","storage":"256 GB"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000014',false),

    -- Lenovo ThinkPad L14 Gen 4 (prd-015)
    ('pvr-00001-0000-0000-0000-000000000031','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'L14G4-I5-8-256','l14g4-i5-8gb-256','ThinkPad L14 Gen4 i5 8GB 256GB SSD',
     0.00,'{"cpu":"Intel i5-1335U","ram":"8 GB","storage":"256 GB SSD"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000015',false),
    ('pvr-00001-0000-0000-0000-000000000032','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'L14G4-I7-16-512','l14g4-i7-16gb-512','ThinkPad L14 Gen4 i7 16GB 512GB SSD',
     8000.00,'{"cpu":"Intel i7-1355U","ram":"16 GB","storage":"512 GB SSD"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000015',false),

    -- Samsung 55" QLED 4K TV (prd-016)
    ('pvr-00001-0000-0000-0000-000000000033','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'SAM-TV55Q80C','sam-tv55q80c-siyah','Samsung 55" QLED 4K Q80C',
     0.00,'{"size":"55 inc","resolution":"4K UHD","panel":"QLED"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000016',false),

    -- LG 27" QHD IPS Monitor (prd-017)
    ('pvr-00001-0000-0000-0000-000000000034','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'LG-27QP500-B','lg-27qp500-siyah','LG 27QP500-B Siyah 27" QHD',
     0.00,'{"color":"Siyah","size":"27 inc","resolution":"QHD 2560x1440"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000017',false),
    ('pvr-00001-0000-0000-0000-000000000035','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'LG-27QP500-W','lg-27qp500-beyaz','LG 27QP500-W Beyaz 27" QHD',
     0.00,'{"color":"Beyaz","size":"27 inc","resolution":"QHD 2560x1440"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000017',false),

    -- Xiaomi Redmi Note 13 Pro (prd-018)
    ('pvr-00001-0000-0000-0000-000000000036','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'REDMIN13P-BLK-256','redmi-n13p-siyah-256','Redmi Note 13 Pro Siyah 256GB',
     0.00,'{"color":"Siyah","storage":"256 GB"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000018',false),
    ('pvr-00001-0000-0000-0000-000000000037','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'REDMIN13P-MOR-256','redmi-n13p-mor-256','Redmi Note 13 Pro Mor 256GB',
     0.00,'{"color":"Mor","storage":"256 GB"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000018',false),
    ('pvr-00001-0000-0000-0000-000000000038','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'REDMIN13P-BLK-512','redmi-n13p-siyah-512','Redmi Note 13 Pro Siyah 512GB',
     2000.00,'{"color":"Siyah","storage":"512 GB"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000018',false),

    -- Xiaomi Pad 6 (prd-019)
    ('pvr-00001-0000-0000-0000-000000000039','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'XIAOMIPAD6-GRI-128','xiaomipad6-gri-128','Xiaomi Pad 6 Gri 128GB',
     0.00,'{"color":"Gri","storage":"128 GB"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000019',false),
    ('pvr-00001-0000-0000-0000-000000000040','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'XIAOMIPAD6-GLD-256','xiaomipad6-gold-256','Xiaomi Pad 6 Gold 256GB',
     3000.00,'{"color":"Gold","storage":"256 GB"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000019',false),

    -- HP Deskjet Plus 4120 (prd-020)
    ('pvr-00001-0000-0000-0000-000000000041','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'HP-DJ4120-WHT','hp-dj4120-beyaz','HP Deskjet Plus 4120 Beyaz',
     0.00,'{"color":"Beyaz","connectivity":"WiFi + USB"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000020',false),

    -- Adidas Trefoil T-Shirt (prd-021)
    ('pvr-00001-0000-0000-0000-000000000042','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'ADIDAS-TRF-WHT-M','adidas-trefoil-beyaz-m','Adidas Trefoil T-Shirt Beyaz M',
     0.00,'{"color":"Beyaz","size":"M"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000021',false),
    ('pvr-00001-0000-0000-0000-000000000043','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'ADIDAS-TRF-WHT-L','adidas-trefoil-beyaz-l','Adidas Trefoil T-Shirt Beyaz L',
     0.00,'{"color":"Beyaz","size":"L"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000021',false),
    ('pvr-00001-0000-0000-0000-000000000044','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'ADIDAS-TRF-BLK-M','adidas-trefoil-siyah-m','Adidas Trefoil T-Shirt Siyah M',
     0.00,'{"color":"Siyah","size":"M"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000021',false),
    ('pvr-00001-0000-0000-0000-000000000045','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'ADIDAS-TRF-BLK-L','adidas-trefoil-siyah-l','Adidas Trefoil T-Shirt Siyah L',
     0.00,'{"color":"Siyah","size":"L"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000021',false),

    -- Levi's 501 (prd-022)
    ('pvr-00001-0000-0000-0000-000000000046','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'LEVIS501-IND-3032','levis-501-mavi-30-32','Levi''s 501 Indigo Mavi W30/L32',
     0.00,'{"color":"Indigo Mavi","size":"W30/L32"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000022',false),
    ('pvr-00001-0000-0000-0000-000000000047','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'LEVIS501-IND-3232','levis-501-mavi-32-32','Levi''s 501 Indigo Mavi W32/L32',
     0.00,'{"color":"Indigo Mavi","size":"W32/L32"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000022',false),
    ('pvr-00001-0000-0000-0000-000000000048','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'LEVIS501-BLK-3232','levis-501-siyah-32-32','Levi''s 501 Siyah W32/L32',
     0.00,'{"color":"Siyah","size":"W32/L32"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000022',false),

    -- Yazlık Midi Elbise (prd-023)
    ('pvr-00001-0000-0000-0000-000000000049','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'MIDI-YSL-S','midi-elbise-yesil-s','Yazlık Midi Elbise Yeşil S',
     0.00,'{"color":"Yesil","size":"S"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000023',false),
    ('pvr-00001-0000-0000-0000-000000000050','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'MIDI-YSL-M','midi-elbise-yesil-m','Yazlık Midi Elbise Yeşil M',
     0.00,'{"color":"Yesil","size":"M"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000023',false),
    ('pvr-00001-0000-0000-0000-000000000051','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'MIDI-EKR-M','midi-elbise-ekru-m','Yazlık Midi Elbise Ekru M',
     0.00,'{"color":"Ekru","size":"M"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000023',false),

    -- Keten Uzun Bluz (prd-024)
    ('pvr-00001-0000-0000-0000-000000000052','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'KETEN-BLZ-WHT-S','keten-bluz-beyaz-s','Keten Uzun Bluz Beyaz S',
     0.00,'{"color":"Beyaz","size":"S"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000024',false),
    ('pvr-00001-0000-0000-0000-000000000053','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'KETEN-BLZ-WHT-M','keten-bluz-beyaz-m','Keten Uzun Bluz Beyaz M',
     0.00,'{"color":"Beyaz","size":"M"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000024',false),
    ('pvr-00001-0000-0000-0000-000000000054','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'KETEN-BLZ-MAV-M','keten-bluz-mavi-m','Keten Uzun Bluz Mavi M',
     0.00,'{"color":"Mavi","size":"M"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000024',false),

    -- Bebek Zıbın Seti (prd-025)
    ('pvr-00001-0000-0000-0000-000000000055','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'BEBEK-ZBN-03-WHT','bebek-zibin-0-3-ay','Bebek 5li Zıbın Seti 0-3 Ay Beyaz',
     0.00,'{"size":"0-3 Ay","color":"Beyaz"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000025',false),
    ('pvr-00001-0000-0000-0000-000000000056','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'BEBEK-ZBN-36-KRM','bebek-zibin-3-6-ay','Bebek 5li Zıbın Seti 3-6 Ay Krem',
     0.00,'{"size":"3-6 Ay","color":"Krem"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000025',false),

    -- Çocuk Kapüşonlu Sweatshirt (prd-026)
    ('pvr-00001-0000-0000-0000-000000000057','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'COCUK-SWT-GRI-45','cocuk-sweat-gri-4-5','Çocuk Kapüşonlu Sweat Gri 4-5 Yaş',
     0.00,'{"color":"Gri","size":"4-5 Yas"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000026',false),
    ('pvr-00001-0000-0000-0000-000000000058','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'COCUK-SWT-GRI-67','cocuk-sweat-gri-6-7','Çocuk Kapüşonlu Sweat Gri 6-7 Yaş',
     0.00,'{"color":"Gri","size":"6-7 Yas"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000026',false),
    ('pvr-00001-0000-0000-0000-000000000059','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'COCUK-SWT-NVY-67','cocuk-sweat-lacivert-6-7','Çocuk Kapüşonlu Sweat Lacivert 6-7 Yaş',
     0.00,'{"color":"Lacivert","size":"6-7 Yas"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000026',false),

    -- Nike Air Max 270 (prd-027)
    ('pvr-00001-0000-0000-0000-000000000060','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'AM270-BLK-42','nike-am270-siyah-42','Nike Air Max 270 Siyah No:42',
     0.00,'{"color":"Siyah","shoe_size":"42"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000027',false),
    ('pvr-00001-0000-0000-0000-000000000061','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'AM270-BLK-43','nike-am270-siyah-43','Nike Air Max 270 Siyah No:43',
     0.00,'{"color":"Siyah","shoe_size":"43"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000027',false),
    ('pvr-00001-0000-0000-0000-000000000062','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'AM270-WHT-42','nike-am270-beyaz-42','Nike Air Max 270 Beyaz No:42',
     0.00,'{"color":"Beyaz","shoe_size":"42"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000027',false),

    -- Deri Oxford Klasik Ayakkabı (prd-028)
    ('pvr-00001-0000-0000-0000-000000000063','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'OXFORD-BLK-42','oxford-siyah-42','Deri Oxford Klasik Ayakkabı Siyah No:42',
     0.00,'{"color":"Siyah","shoe_size":"42"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000028',false),
    ('pvr-00001-0000-0000-0000-000000000064','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'OXFORD-BLK-43','oxford-siyah-43','Deri Oxford Klasik Ayakkabı Siyah No:43',
     0.00,'{"color":"Siyah","shoe_size":"43"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000028',false),
    ('pvr-00001-0000-0000-0000-000000000065','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'OXFORD-BRW-42','oxford-kahve-42','Deri Oxford Klasik Ayakkabı Kahve No:42',
     0.00,'{"color":"Kahve","shoe_size":"42"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000028',false),

    -- Faber-Castell Polychromos (prd-029)
    ('pvr-00001-0000-0000-0000-000000000066','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'FC-POLY-12','fc-polychromos-12li','Faber-Castell Polychromos 12li Set',
     0.00,'{"content":"12 Renk"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000029',false),
    ('pvr-00001-0000-0000-0000-000000000067','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'FC-POLY-24','fc-polychromos-24li','Faber-Castell Polychromos 24li Set',
     0.00,'{"content":"24 Renk"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000029',false),

    -- Post-it (prd-030)
    ('pvr-00001-0000-0000-0000-000000000068','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'POSTIT-5RNK','postit-5-renk-karma','Post-it 5 Renk Karma Set',
     0.00,'{"content":"5 Renk / 125 Yaprak"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000030',false),
    ('pvr-00001-0000-0000-0000-000000000069','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'POSTIT-SAR-100','postit-sari-100yaprak','Post-it 3x3 Sarı 100 Yaprak',
     0.00,'{"content":"100 Yaprak","color":"Sari"}'::jsonb,
     'prd-00001-0000-0000-0000-000000000030',false)
ON CONFLICT (id) DO NOTHING;

-- ── 16c. BARCODES (pvr-025 → pvr-069) ───────────────────────
INSERT INTO barcodes
(id, create_user, company_code, create_time, last_modified_time,
 barcode_code, barcode_type, is_primary, is_active, usage_count, variant_id)
VALUES
    ('bar-00001-0000-0000-0000-000000000025','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000025','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000025'),
    ('bar-00001-0000-0000-0000-000000000026','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000026','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000026'),
    ('bar-00001-0000-0000-0000-000000000027','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000027','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000027'),
    ('bar-00001-0000-0000-0000-000000000028','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000028','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000028'),
    ('bar-00001-0000-0000-0000-000000000029','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000029','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000029'),
    ('bar-00001-0000-0000-0000-000000000030','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000030','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000030'),
    ('bar-00001-0000-0000-0000-000000000031','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000031','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000031'),
    ('bar-00001-0000-0000-0000-000000000032','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000032','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000032'),
    ('bar-00001-0000-0000-0000-000000000033','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000033','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000033'),
    ('bar-00001-0000-0000-0000-000000000034','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000034','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000034'),
    ('bar-00001-0000-0000-0000-000000000035','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000035','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000035'),
    ('bar-00001-0000-0000-0000-000000000036','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000036','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000036'),
    ('bar-00001-0000-0000-0000-000000000037','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000037','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000037'),
    ('bar-00001-0000-0000-0000-000000000038','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000038','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000038'),
    ('bar-00001-0000-0000-0000-000000000039','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000039','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000039'),
    ('bar-00001-0000-0000-0000-000000000040','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000040','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000040'),
    ('bar-00001-0000-0000-0000-000000000041','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000041','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000041'),
    ('bar-00001-0000-0000-0000-000000000042','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000042','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000042'),
    ('bar-00001-0000-0000-0000-000000000043','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000043','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000043'),
    ('bar-00001-0000-0000-0000-000000000044','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000044','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000044'),
    ('bar-00001-0000-0000-0000-000000000045','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000045','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000045'),
    ('bar-00001-0000-0000-0000-000000000046','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000046','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000046'),
    ('bar-00001-0000-0000-0000-000000000047','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000047','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000047'),
    ('bar-00001-0000-0000-0000-000000000048','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000048','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000048'),
    ('bar-00001-0000-0000-0000-000000000049','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000049','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000049'),
    ('bar-00001-0000-0000-0000-000000000050','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000050','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000050'),
    ('bar-00001-0000-0000-0000-000000000051','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000051','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000051'),
    ('bar-00001-0000-0000-0000-000000000052','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000052','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000052'),
    ('bar-00001-0000-0000-0000-000000000053','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000053','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000053'),
    ('bar-00001-0000-0000-0000-000000000054','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000054','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000054'),
    ('bar-00001-0000-0000-0000-000000000055','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000055','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000055'),
    ('bar-00001-0000-0000-0000-000000000056','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000056','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000056'),
    ('bar-00001-0000-0000-0000-000000000057','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000057','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000057'),
    ('bar-00001-0000-0000-0000-000000000058','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000058','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000058'),
    ('bar-00001-0000-0000-0000-000000000059','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000059','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000059'),
    ('bar-00001-0000-0000-0000-000000000060','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000060','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000060'),
    ('bar-00001-0000-0000-0000-000000000061','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000061','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000061'),
    ('bar-00001-0000-0000-0000-000000000062','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000062','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000062'),
    ('bar-00001-0000-0000-0000-000000000063','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000063','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000063'),
    ('bar-00001-0000-0000-0000-000000000064','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000064','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000064'),
    ('bar-00001-0000-0000-0000-000000000065','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000065','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000065'),
    ('bar-00001-0000-0000-0000-000000000066','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000066','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000066'),
    ('bar-00001-0000-0000-0000-000000000067','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000067','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000067'),
    ('bar-00001-0000-0000-0000-000000000068','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000068','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000068'),
    ('bar-00001-0000-0000-0000-000000000069','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'8690000000069','EAN13',true,true,0,'pvr-00001-0000-0000-0000-000000000069')
ON CONFLICT (id) DO NOTHING;

-- ── 16d. VARIANT_PRICING (pvr-025 → pvr-069) ─────────────────
-- Fiyatlar TRY cinsinden — purchase_price (alış), sale_price (satış)
INSERT INTO variant_pricing
(id, create_user, company_code, create_time, last_modified_time,
 variant_id, purchase_price, sale_price, currency, valid_from,
 vat_rate, vat_included, tax_exempt)
VALUES
    -- iPhone 15 (20% KDV)
    ('vpr-00001-0000-0000-0000-000000000025','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000025', 35000.00, 47999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000026','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000026', 35000.00, 47999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000027','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000027', 40000.00, 54999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000028','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000028', 40000.00, 54999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    -- Samsung Galaxy Tab S9 (20% KDV)
    ('vpr-00001-0000-0000-0000-000000000029','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000029', 28000.00, 38999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000030','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000030', 33000.00, 44999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    -- Lenovo ThinkPad L14 (20% KDV)
    ('vpr-00001-0000-0000-0000-000000000031','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000031', 32000.00, 44999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000032','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000032', 40000.00, 54999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    -- Samsung 55" QLED TV (20% KDV)
    ('vpr-00001-0000-0000-0000-000000000033','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000033', 28000.00, 39999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    -- LG 27" QHD Monitor (20% KDV)
    ('vpr-00001-0000-0000-0000-000000000034','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000034',  8500.00, 11999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000035','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000035',  8500.00, 11999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    -- Xiaomi Redmi Note 13 Pro (20% KDV)
    ('vpr-00001-0000-0000-0000-000000000036','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000036', 15000.00, 21999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000037','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000037', 15000.00, 21999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000038','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000038', 18000.00, 25999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    -- Xiaomi Pad 6 (20% KDV)
    ('vpr-00001-0000-0000-0000-000000000039','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000039', 13000.00, 18999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000040','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000040', 16000.00, 22999.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    -- HP Deskjet Plus 4120 (20% KDV)
    ('vpr-00001-0000-0000-0000-000000000041','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000041',  2200.00,  3299.00,'TRY',CURRENT_TIMESTAMP,20.00,false,false),
    -- Adidas Trefoil T-Shirt (8% KDV)
    ('vpr-00001-0000-0000-0000-000000000042','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000042',   150.00,   399.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000043','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000043',   150.00,   399.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000044','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000044',   150.00,   399.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000045','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000045',   150.00,   399.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    -- Levi's 501 (8% KDV)
    ('vpr-00001-0000-0000-0000-000000000046','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000046',   700.00,  1799.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000047','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000047',   700.00,  1799.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000048','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000048',   700.00,  1799.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    -- Yazlık Midi Elbise (8% KDV)
    ('vpr-00001-0000-0000-0000-000000000049','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000049',   180.00,   499.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000050','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000050',   180.00,   499.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000051','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000051',   180.00,   499.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    -- Keten Uzun Bluz (8% KDV)
    ('vpr-00001-0000-0000-0000-000000000052','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000052',   120.00,   349.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000053','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000053',   120.00,   349.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000054','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000054',   120.00,   349.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    -- Bebek Zıbın Seti (8% KDV)
    ('vpr-00001-0000-0000-0000-000000000055','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000055',    80.00,   199.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000056','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000056',    80.00,   199.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    -- Çocuk Kapüşonlu Sweatshirt (8% KDV)
    ('vpr-00001-0000-0000-0000-000000000057','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000057',   130.00,   349.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000058','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000058',   130.00,   349.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000059','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000059',   130.00,   349.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    -- Nike Air Max 270 (8% KDV)
    ('vpr-00001-0000-0000-0000-000000000060','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000060',  2500.00,  3999.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000061','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000061',  2500.00,  3999.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000062','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000062',  2500.00,  3999.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    -- Deri Oxford Klasik Ayakkabı (8% KDV)
    ('vpr-00001-0000-0000-0000-000000000063','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000063',   900.00,  2299.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000064','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000064',   900.00,  2299.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000065','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000065',   900.00,  2299.00,'TRY',CURRENT_TIMESTAMP, 8.00,false,false),
    -- Faber-Castell Polychromos (1% KDV)
    ('vpr-00001-0000-0000-0000-000000000066','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000066',    80.00,   199.00,'TRY',CURRENT_TIMESTAMP, 1.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000067','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000067',   150.00,   369.00,'TRY',CURRENT_TIMESTAMP, 1.00,false,false),
    -- Post-it (1% KDV)
    ('vpr-00001-0000-0000-0000-000000000068','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000068',    45.00,    99.00,'TRY',CURRENT_TIMESTAMP, 1.00,false,false),
    ('vpr-00001-0000-0000-0000-000000000069','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000069',    25.00,    59.00,'TRY',CURRENT_TIMESTAMP, 1.00,false,false)
ON CONFLICT (id) DO NOTHING;

-- ── 16e. STOCK_MOVEMENTS — başlangıç stoğu (PURCHASE_IN) ─────
INSERT INTO stock_movements
(id, create_user, company_code, create_time, last_modified_time,
 variant_id, store_id, warehouse_id, movement_type, quantity)
VALUES
    -- iPhone 15 (15 adet/varyant)
    ('sm-p2-0025-0000-0000-0000-000000000001','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000025','STORE-01','WH-01','PURCHASE_IN',15),
    ('sm-p2-0026-0000-0000-0000-000000000002','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000026','STORE-01','WH-01','PURCHASE_IN',15),
    ('sm-p2-0027-0000-0000-0000-000000000003','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000027','STORE-01','WH-01','PURCHASE_IN',10),
    ('sm-p2-0028-0000-0000-0000-000000000004','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000028','STORE-01','WH-01','PURCHASE_IN',10),
    -- Samsung Galaxy Tab S9
    ('sm-p2-0029-0000-0000-0000-000000000005','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000029','STORE-01','WH-01','PURCHASE_IN',10),
    ('sm-p2-0030-0000-0000-0000-000000000006','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000030','STORE-01','WH-01','PURCHASE_IN',8),
    -- Lenovo ThinkPad L14
    ('sm-p2-0031-0000-0000-0000-000000000007','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000031','STORE-01','WH-01','PURCHASE_IN',5),
    ('sm-p2-0032-0000-0000-0000-000000000008','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000032','STORE-01','WH-01','PURCHASE_IN',3),
    -- Samsung 55" QLED TV
    ('sm-p2-0033-0000-0000-0000-000000000009','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000033','STORE-01','WH-01','PURCHASE_IN',8),
    -- LG 27" QHD Monitor
    ('sm-p2-0034-0000-0000-0000-000000000010','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000034','STORE-01','WH-01','PURCHASE_IN',12),
    ('sm-p2-0035-0000-0000-0000-000000000011','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000035','STORE-01','WH-01','PURCHASE_IN',12),
    -- Xiaomi Redmi Note 13 Pro
    ('sm-p2-0036-0000-0000-0000-000000000012','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000036','STORE-01','WH-01','PURCHASE_IN',20),
    ('sm-p2-0037-0000-0000-0000-000000000013','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000037','STORE-01','WH-01','PURCHASE_IN',20),
    ('sm-p2-0038-0000-0000-0000-000000000014','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000038','STORE-01','WH-01','PURCHASE_IN',10),
    -- Xiaomi Pad 6
    ('sm-p2-0039-0000-0000-0000-000000000015','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000039','STORE-01','WH-01','PURCHASE_IN',8),
    ('sm-p2-0040-0000-0000-0000-000000000016','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000040','STORE-01','WH-01','PURCHASE_IN',6),
    -- HP Deskjet Plus 4120
    ('sm-p2-0041-0000-0000-0000-000000000017','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000041','STORE-01','WH-01','PURCHASE_IN',15),
    -- Adidas Trefoil T-Shirt (60 adet/varyant)
    ('sm-p2-0042-0000-0000-0000-000000000018','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000042','STORE-01','WH-01','PURCHASE_IN',60),
    ('sm-p2-0043-0000-0000-0000-000000000019','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000043','STORE-01','WH-01','PURCHASE_IN',60),
    ('sm-p2-0044-0000-0000-0000-000000000020','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000044','STORE-01','WH-01','PURCHASE_IN',60),
    ('sm-p2-0045-0000-0000-0000-000000000021','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000045','STORE-01','WH-01','PURCHASE_IN',60),
    -- Levi's 501
    ('sm-p2-0046-0000-0000-0000-000000000022','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000046','STORE-01','WH-01','PURCHASE_IN',30),
    ('sm-p2-0047-0000-0000-0000-000000000023','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000047','STORE-01','WH-01','PURCHASE_IN',30),
    ('sm-p2-0048-0000-0000-0000-000000000024','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000048','STORE-01','WH-01','PURCHASE_IN',25),
    -- Yazlık Midi Elbise
    ('sm-p2-0049-0000-0000-0000-000000000025','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000049','STORE-01','WH-01','PURCHASE_IN',25),
    ('sm-p2-0050-0000-0000-0000-000000000026','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000050','STORE-01','WH-01','PURCHASE_IN',25),
    ('sm-p2-0051-0000-0000-0000-000000000027','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000051','STORE-01','WH-01','PURCHASE_IN',20),
    -- Keten Uzun Bluz
    ('sm-p2-0052-0000-0000-0000-000000000028','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000052','STORE-01','WH-01','PURCHASE_IN',25),
    ('sm-p2-0053-0000-0000-0000-000000000029','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000053','STORE-01','WH-01','PURCHASE_IN',25),
    ('sm-p2-0054-0000-0000-0000-000000000030','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000054','STORE-01','WH-01','PURCHASE_IN',20),
    -- Bebek Zıbın Seti
    ('sm-p2-0055-0000-0000-0000-000000000031','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000055','STORE-01','WH-01','PURCHASE_IN',30),
    ('sm-p2-0056-0000-0000-0000-000000000032','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000056','STORE-01','WH-01','PURCHASE_IN',30),
    -- Çocuk Kapüşonlu Sweatshirt
    ('sm-p2-0057-0000-0000-0000-000000000033','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000057','STORE-01','WH-01','PURCHASE_IN',40),
    ('sm-p2-0058-0000-0000-0000-000000000034','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000058','STORE-01','WH-01','PURCHASE_IN',40),
    ('sm-p2-0059-0000-0000-0000-000000000035','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000059','STORE-01','WH-01','PURCHASE_IN',35),
    -- Nike Air Max 270
    ('sm-p2-0060-0000-0000-0000-000000000036','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000060','STORE-01','WH-01','PURCHASE_IN',20),
    ('sm-p2-0061-0000-0000-0000-000000000037','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000061','STORE-01','WH-01','PURCHASE_IN',20),
    ('sm-p2-0062-0000-0000-0000-000000000038','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000062','STORE-01','WH-01','PURCHASE_IN',18),
    -- Deri Oxford Klasik Ayakkabı
    ('sm-p2-0063-0000-0000-0000-000000000039','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000063','STORE-01','WH-01','PURCHASE_IN',15),
    ('sm-p2-0064-0000-0000-0000-000000000040','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000064','STORE-01','WH-01','PURCHASE_IN',15),
    ('sm-p2-0065-0000-0000-0000-000000000041','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000065','STORE-01','WH-01','PURCHASE_IN',12),
    -- Faber-Castell Polychromos
    ('sm-p2-0066-0000-0000-0000-000000000042','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000066','STORE-01','WH-01','PURCHASE_IN',50),
    ('sm-p2-0067-0000-0000-0000-000000000043','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000067','STORE-01','WH-01','PURCHASE_IN',30),
    -- Post-it
    ('sm-p2-0068-0000-0000-0000-000000000044','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000068','STORE-01','WH-01','PURCHASE_IN',100),
    ('sm-p2-0069-0000-0000-0000-000000000045','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'pvr-00001-0000-0000-0000-000000000069','STORE-01','WH-01','PURCHASE_IN',100)
ON CONFLICT (id) DO NOTHING;

-- ============================================================
-- EKSİK STOK HAREKETLERİ (pvr-012, 014-018, 020-024)
-- Bu varyantların PURCHASE_IN hareketi yoktu → POS'ta "tükendi" görünüyordu
-- ============================================================
INSERT INTO stock_movements
(id, create_user, company_code, create_time, last_modified_time,
 variant_id, store_id, warehouse_id, movement_type, quantity)
VALUES
    -- Samsung Galaxy A35 Lavanta
    ('stm-fix-0000-0000-0000-000000000012','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'pvr-00001-0000-0000-0000-000000000012','STORE-01','WH-01','PURCHASE_IN',25),
    -- JBL Tune 510BT Beyaz
    ('stm-fix-0000-0000-0000-000000000014','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'pvr-00001-0000-0000-0000-000000000014','STORE-01','WH-01','PURCHASE_IN',30),
    -- Anker Soundcore Life Q20
    ('stm-fix-0000-0000-0000-000000000015','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'pvr-00001-0000-0000-0000-000000000015','STORE-01','WH-01','PURCHASE_IN',20),
    -- Oxford Gömlek Beyaz M
    ('stm-fix-0000-0000-0000-000000000016','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'pvr-00001-0000-0000-0000-000000000016','STORE-01','WH-01','PURCHASE_IN',40),
    -- Oxford Gömlek Beyaz L
    ('stm-fix-0000-0000-0000-000000000017','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'pvr-00001-0000-0000-0000-000000000017','STORE-01','WH-01','PURCHASE_IN',35),
    -- Oxford Gömlek Mavi L
    ('stm-fix-0000-0000-0000-000000000018','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'pvr-00001-0000-0000-0000-000000000018','STORE-01','WH-01','PURCHASE_IN',30),
    -- Jogger Eşofman Altı Gri L
    ('stm-fix-0000-0000-0000-000000000020','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'pvr-00001-0000-0000-0000-000000000020','STORE-01','WH-01','PURCHASE_IN',45),
    -- Jogger Eşofman Altı Lacivert L
    ('stm-fix-0000-0000-0000-000000000021','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'pvr-00001-0000-0000-0000-000000000021','STORE-01','WH-01','PURCHASE_IN',40),
    -- Stabilo Boss Highlighter 6lı Set
    ('stm-fix-0000-0000-0000-000000000022','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'pvr-00001-0000-0000-0000-000000000022','STORE-01','WH-01','PURCHASE_IN',60),
    -- Leitz A4 Plastik Dosya 100lü Kutu
    ('stm-fix-0000-0000-0000-000000000023','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'pvr-00001-0000-0000-0000-000000000023','STORE-01','WH-01','PURCHASE_IN',50),
    -- Scotch Bant 19mm x 33m
    ('stm-fix-0000-0000-0000-000000000024','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'pvr-00001-0000-0000-0000-000000000024','STORE-01','WH-01','PURCHASE_IN',80)
ON CONFLICT (id) DO NOTHING;

-- ============================================================
-- OTO YEDEK PARÇA KATEGORİLERİ → COMPANY_CATEGORIES
-- cat-auto-* kategorileri SEDCORE firmasına bağlanıyor
-- Böylece POS ekranında oto yedek parça ürünleri de görünür
-- ============================================================
INSERT INTO company_categories
(id, create_user, company_code, create_time, last_modified_time,
 category_id, is_active, display_order)
VALUES
    ('cc-auto-0000-0000-0000-000000000001','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'cat-auto-0000-0000-0000-000000000001',true,21),  -- Fren Sistemi
    ('cc-auto-0000-0000-0000-000000000002','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'cat-auto-0000-0000-0000-000000000002',true,22),  -- Suspansiyon
    ('cc-auto-0000-0000-0000-000000000003','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'cat-auto-0000-0000-0000-000000000003',true,23),  -- Motor Parçaları
    ('cc-auto-0000-0000-0000-000000000004','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'cat-auto-0000-0000-0000-000000000004',true,24),  -- Filtreler
    ('cc-auto-0000-0000-0000-000000000005','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'cat-auto-0000-0000-0000-000000000005',true,25),  -- Aydınlatma
    ('cc-auto-0000-0000-0000-000000000006','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'cat-auto-0000-0000-0000-000000000006',true,26),  -- Elektrik ve Akü
    ('cc-auto-0000-0000-0000-000000000007','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'cat-auto-0000-0000-0000-000000000007',true,27),  -- Soğutma Sistemi
    ('cc-auto-0000-0000-0000-000000000008','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'cat-auto-0000-0000-0000-000000000008',true,28),  -- Egzoz Sistemi
    ('cc-auto-0000-0000-0000-000000000009','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'cat-auto-0000-0000-0000-000000000009',true,29),  -- Debriyaj ve Şanzıman
    ('cc-auto-0000-0000-0000-000000000010','SYSTEM','SEDCORE',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
     'cat-auto-0000-0000-0000-000000000010',true,30)   -- Kayış ve Gergi
ON CONFLICT (id) DO NOTHING;
