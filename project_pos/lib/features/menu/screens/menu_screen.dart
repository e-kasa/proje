...
import 'package:project_pos/providers/menu_provider.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final List<_CategoryData> defaultCategories = [
      _CategoryData('SATIŞ & OPERASYON', AppColors.success, [
        ...
        _MenuAction('Satın Almalar',    Icons.shopping_bag_outlined, '/purchases',  'Tedarikçi alım siparişleri'),
      ...
      _CategoryData('ÜRÜN KATALOĞU', AppColors.primary, [
        ...
        _MenuAction('Toplu Ürün Girişi',  Icons.playlist_add,       '/inventory/batch-entry',       'Çoklu ürün ve stok girişi'),
        _MenuAction('Kategoriler',        Icons.category,           '/inventory/categories',        'Ürün gruplandırma'),
        _MenuAction('Firma Kategorileri', Icons.tune,               '/categories/company-setup',    'Firmaya özel kategori seçimi'),
        _MenuAction('Barkod Yönetimi',    Icons.barcode_reader,     '/inventory/barcodes',          'Barkod tanımları ve atama'),
      ...
      _CategoryData('STOK & DEPO', Colors.brown, [
        ...
        _MenuAction('Stok Hareketleri', Icons.compare_arrows,             '/stock/movements',        'Giriş/Çıkış hareket logu'),
        _MenuAction('Çok Depo Stok',    Icons.domain,                     '/stock/multi-warehouse',  'Depo bazlı stok karşılaştırma'),
        _MenuAction('Stok Değer Rap.',  Icons.price_check,                '/stock/value-report',     'Toplam stok değeri analizi'),
        ...
        _MenuAction('Mağazalar',        Icons.storefront_outlined,        '/stores',                 'Mağaza tanımları ve yönetimi'),
      ]),
      _CategoryData('FİNANS & CARİ', AppColors.info, [
        _MenuAction('Finans Paneli',    Icons.dashboard_outlined,         '/finance',                'Gelir/Gider genel bakış'),
        _MenuAction('Cari Hesaplar',    Icons.account_balance_wallet,     '/accounts',               'Borç/Alacak takibi'),
        _MenuAction('Gecikmiş Takip',   Icons.warning_amber_outlined,     '/accounts/overdue',       'Vadesi geçmiş alacaklar'),
        ...
        _MenuAction('Gelir Ekle',       Icons.arrow_upward,               '/finance/add-income',     'Gelir kaydı oluştur'),
        _MenuAction('Ödemeler',         Icons.payments_outlined,          '/finance/payments',       'Ödeme listesi ve takibi'),
      ...
      _CategoryData('ANALİZ & SİSTEM', Colors.purple, [
        ...
        _MenuAction('Satış Analizi',     Icons.show_chart,          '/reports/sales-summary',      'Satış hacmi ve gelir'),
        _MenuAction('Ürün Analizi',      Icons.inventory_2_outlined, '/reports/product-analysis',  'En çok satan ürünler'),
        _MenuAction('Müşteri Analizi',   Icons.people_outline,      '/reports/customer-analysis',  'Müşteri bazlı satış analizi'),
        _MenuAction('Kâr/Zarar',         Icons.balance,             '/reports/profit-overview',    'Gelir/gider kâr analizi'),
        _MenuAction('Günlük Özet',       Icons.today,               '/reports/daily-summary',      'Günlük kapanış özeti'),
      ...
      _CategoryData('İNSAN KAYNAKLARI', Colors.teal, [
        _MenuAction('Çalışanlar', Icons.badge_outlined, '/hrm/employees', 'Personel listesi ve yönetimi'),
      ]),
    ];
