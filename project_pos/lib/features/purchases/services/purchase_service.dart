...
class PurchaseService {
  ...
  Future<Map<String, dynamic>> createPurchaseReturn(
    ...
    try {
      final response = await _apiClient.post('$_base/$id/returns', data: data);
      return (response.data['data'] as Map<String, dynamic>?) ?? {};
    } catch (e) {
