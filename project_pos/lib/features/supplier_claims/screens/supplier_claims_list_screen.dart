    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 8),
          _filterChip(t('su.claim_status_resolved_discount'),
              ClaimStatus.resolvedDiscount, state.statusFilter),
          const SizedBox(width: 8),
          _filterChip(t('su.claim_status_resolved_delivery'),
              ClaimStatus.resolvedDelivery, state.statusFilter),
          const SizedBox(width: 8),
          _filterChip(t('su.claim_status_resolved_return'),
              ClaimStatus.resolvedReturn, state.statusFilter),
          const SizedBox(width: 8),
