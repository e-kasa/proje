...
import {logout} from "../../core/redux/authSlice.ts";
...
const Header = () => {
  ...
  const isElementVisible = (element: any) => {
    ...
    const handleLogout = () => {
        dispatch(logout()); // 🔹 Redux state temizlenir
          ...
          <ul className="nav user-menu">
            ...
            <li className="nav-item dropdown has-arrow main-drop profile-nav">
              ...
              <div className="dropdown-menu menu-drop-user">
                ...
                <hr className="my-2" />
                <button className="dropdown-item logout pb-0" onClick={handleLogout} to={route.signin}>
