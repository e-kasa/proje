...
export const all_routes = {
  ...
  pricing: "/pricing",
  contact: "/contacts",
  productCreateWizard:"/4",

  // Storefront E-Commerce
  storefrontHome: "/store",
  storefrontProducts: "/store/products",
  storefrontProductDetail: "/store/product/:id",
  storefrontCart: "/store/cart",
  storefrontWishlist: "/store/wishlist",
  storefrontCheckout: "/store/checkout",
  storefrontOrders: "/store/orders",
