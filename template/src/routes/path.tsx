...
import ProductCreateWizard from "../feature-module/inventory/ProductCreateWizard.tsx";
...
const EcommerceDashboard = lazy(
  () => import("../feature-module/dashboard/EcommerceDashboard")
);
...
const AddCategory = lazy(
  () => import("../feature-module/inventory/add-category")
);
...
// Storefront Pages
const StorefrontHome = lazy(() => import("../feature-module/storefront/StorefrontHome"));
const StorefrontProducts = lazy(() => import("../feature-module/storefront/StorefrontProducts"));
const StorefrontProductDetail = lazy(() => import("../feature-module/storefront/StorefrontProductDetail"));
const StorefrontCart = lazy(() => import("../feature-module/storefront/StorefrontCart"));
const StorefrontCheckout = lazy(() => import("../feature-module/storefront/StorefrontCheckout"));
const StorefrontWishlist = lazy(() => import("../feature-module/storefront/StorefrontWishlist"));
const StorefrontOrders = lazy(() => import("../feature-module/storefront/StorefrontOrders"));

const routes = all_routes;

// Storefront routes (e-commerce public-facing pages with their own layout)
export const storefrontRoutes = [
  {
    id: "sf-1",
    path: routes.storefrontHome,
  ...
  {
    id: "sf-2",
    path: routes.storefrontProducts,
  ...
  {
    id: "sf-3",
    path: routes.storefrontProductDetail,
  ...
  {
    id: "sf-4",
    path: routes.storefrontCart,
    name: "storefront-cart",
    element: <StorefrontCart />,
    route: Route,
  },
  {
    id: "sf-5",
    path: routes.storefrontWishlist,
    name: "storefront-wishlist",
    element: <StorefrontWishlist />,
    route: Route,
  },
  {
    id: "sf-6",
    path: routes.storefrontCheckout,
...
export const authRoutes = [
  ...
  {
    id: 4,
    path: routes.ecommercedashboard,
...
export const posPages=[
  ...
  },
  {
    ...
    {
        id: 29,
        path: routes.productCreateWizard,
        name: "4",
        element: <ProductCreateWizard />,
        route: Route,
    },
